document.addEventListener('DOMContentLoaded', function () {
    ...
    const temples = [
        ...
        {
            templeName: "Georgia Atlanta",
            location: "Atlanta, Georgia",
            dedicated: "2004, October, 12",
            area: 96642,
            imageUrl: "https://content.churchofjesuschrist.org/templesldsorg/bc/Temples/photo-galleries/atlanta-georgia/400x640/atlanta-temple-lds-811747-wallpaper.jpg"
        },
        {
    ...
    navLinks.forEach(link => {
        link.addEventListener('click', function (event) {
            ...
            if (filter === 'home') {
                displayTemples(unfilteredTemples); 
            } else {
